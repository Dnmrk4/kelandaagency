    ...
    < >
      ...
      <div className="snap-y scroll-smooth bg-backpattern">
        <div className="container flex flex-col-reverse justify-between pt-20 pb-32 mx-auto md:pt-32 snap-start md:flex-row">
          ...
          <div className="justify-center mx-auto">
            {/* <Image
              width={500}
              height={500}
              src="/assets/kelanda.png"
              alt="A"
              className="justify-center max-w-xs mx-auto bg-transparent rounded-sm shadow-xl max-h-xs mt-28 w-72 h-72 shadow-slate-400"
            /> */}
          </div>
        </div>
        ...
        <div className="container flex flex-col justify-center mx-auto mt-24 mb-24 space-y-24 snap-start ">
          <div className="mb-16">
          <h3 className="text-3xl text-center font-head1kod"> Passport application</h3>
          <h3 className="text-3xl text-center font-head1kod"> Visa processing</h3>
